...
# Ploopy Nano 2 - Pointer Rotation firmware builder
#
# Builds: ploopyco/nano_2/rev2_003:rotation
#
...
FIRMWARE_NAME="ploopyco_nano_2_rev2_003_rotation.uf2"
FIRMWARE_SOURCE="$QMK_DIR/.build/$FIRMWARE_NAME"
ROOT_FIRMWARE="$QMK_DIR/$FIRMWARE_NAME"

DOCKER_IMAGE="ghcr.io/qmk/qmk_cli"
BUILD_TARGET="ploopyco/nano_2/rev2_003:rotation"

printf '\n=== PLOOPY NANO 2 ROTATION FIRMWARE BUILD ===\n\n'
